#!/usr/bin/env python3
"""
Fleunce Telegram Bot Runner - 100% Self-contained Multi-User Language Teacher
Bot Username: @FleunceTeacherBot
...
logger = logging.getLogger("fleunce_bot")
...
def build_language_keyboard():
    inline_keyboard = [
        [{"text": "🚀 Ouvrir la Mini App Fleunce", "web_app": {"url": "https://ia2213.github.io/fleunce-gemini/"}}]
    ]
    row = []
...
def handle_update(update):
    if "message" in update:
        ...
        if text.startswith("/start") or text.startswith("/setup"):
            ...
            welcome = (
                "👋 *Bienvenue sur @FleunceTeacherBot !*\n\n"
...
def main():
    logger.info("Starting Fleunce Telegram Bot polling loop...")
    offset = 0
    while True:
        try:
