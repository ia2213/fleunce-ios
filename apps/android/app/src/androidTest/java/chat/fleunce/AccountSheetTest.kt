...
import chat.fleunce.ui.AccountSheet
...
class AccountSheetTest {
    ...
    @Test fun unavailableGoogleDoesNotLaunchAndExplainsGuestAccess() {
        ...
        compose.onNodeWithText("You can keep using Fleunce without an account.", substring = true).assertExists()
    }
    @Test fun accountShowsMinutesAndDeletionRequiresConfirmation() {
        ...
        compose.setContent { FleunceTheme { AccountSheet(state, {}, {}, {}, { deletions++ }, {}) } }
        ...
        compose.onNodeWithText("Delete your Fleunce account", substring = true).assertIsDisplayed()
    ...
    @Test fun finalSecondsAreVisibleAndAnUnavailableStoreDoesNotOfferPurchases() {
        compose.setContent { FleunceTheme { AccountSheet(member, {}, {}, {}, {}, {}) } }
    ...
    @Test fun blockedDeletionOpensOnlyAnExplicitSupportDraftWithoutAccountData() {
        ...
        compose.setContent { CompositionLocalProvider(LocalUriHandler provides uri) { FleunceTheme {
        ...
        compose.runOnIdle {
            assertEquals(listOf("mailto:hi@hackmamba.io?subject=Fleunce%20account%20deletion%20request"), opened)
            assertEquals(0, deletions)
        }
        ...
        compose.runOnIdle { assertEquals("https://fleunce.chat/support/#delete-account", opened.last()) }
    }
    ...
    @Test fun noEmailOrBrowserAppKeepsACopyableContactAndDoesNotClaimSubmission() {
        ...
        compose.setContent { CompositionLocalProvider(LocalUriHandler provides uri, LocalClipboardManager provides clipboard) { FleunceTheme {
    ...
    @Test fun deletionSupportCanBeRequestedBeforeAnAutomaticAttemptAndClosesOnAccountChange() {
        ...
        compose.setContent { FleunceTheme { AccountSheet(state.value, {}, {}, {}, { deletions++ }, {}) } }
