...
import chat.fleunce.ui.TypedReplySheet
...
class TypedReplySheetTest {
    ...
    @Test fun replyCanBeEnteredAndSentFromTheSheetWithoutLosingTheActionToTheKeyboard() {
        ...
        compose.setContent { FleunceTheme { TypedReplySheet("Spanish", false, { sent = it }, { dismissed = true }, completedSends = successes.intValue) } }
    ...
    @Test fun failureKeepsDraftAndSendActionReachable() {
        ...
        var dismissed = false
        compose.setContent { FleunceTheme { TypedReplySheet("Spanish", false, { failure.value = "Connection lost. Try again." },
