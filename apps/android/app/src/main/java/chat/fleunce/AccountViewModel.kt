...
import chat.fleunce.core.AccountController
import chat.fleunce.core.AccountState
import chat.fleunce.core.AccountMutationCoordinator
import chat.fleunce.network.AccountSessionStore
import chat.fleunce.network.ManagedAccountClient
import chat.fleunce.network.ManagedAccountConfiguration
...
class AccountViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private suspend fun clearGoogleIfSignedOut() {
        ...
        catch (_: Exception) { /* The Fleunce session has already been removed. */ }
    }
}
