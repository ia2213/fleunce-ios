...
import chat.fleunce.core.GuestInstallation
import chat.fleunce.core.GuestInstallationStorage
...
class GuestInstallationStore(context: Context, origin: String) : GuestInstallationStorage {
    private val preferences = context.applicationContext.getSharedPreferences("fleunce_guest_installation", Context.MODE_PRIVATE)
    private val binding = "${context.packageName}|$origin|v1".toByteArray(Charsets.UTF_8)
    private val alias = "chat.fleunce.guest.aes"
