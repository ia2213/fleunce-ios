...
/** Installation identity and guest bearers stay on the configured Fleunce origin. No identity in URLs. */
                    ...
                    try {
                        val value = response.use {
                            ...
                            if (!it.isSuccessful) {
                                ...
                                throw AccountFailure.Http(it.code, code, safeRequestErrorReference(it.header("X-Fleunce-Error-Reference")))
                            }
