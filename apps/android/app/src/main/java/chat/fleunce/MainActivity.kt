...
import chat.fleunce.network.IcuHanReader
import chat.fleunce.ui.FleunceApp
...
class MainActivity : ComponentActivity() {
    private val vm: FleunceViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            FleunceStartup(loading = vm.loadingHistory) {
            FleunceApp(
                vm = vm,
                ...
                onExport = { exportLauncher.launch("Fleunce-learning-backup.json") },
