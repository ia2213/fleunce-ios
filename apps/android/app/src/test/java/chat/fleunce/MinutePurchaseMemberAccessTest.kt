...
class MinutePurchaseMemberAccessTest {
    ...
    @Test fun capabilityRequiresExplicitFlagValidEnvironmentConfigurationAndPermanentPackage() {
        assertFalse(MinutePurchaseCapability.checked(false, "test", true, "chat.fleunce.android").enabled)
        assertFalse(MinutePurchaseCapability.checked(true, "staging", true, "chat.fleunce.android").enabled)
        assertFalse(MinutePurchaseCapability.checked(true, "test", false, "chat.fleunce.android").enabled)
        assertFalse(MinutePurchaseCapability.checked(true, "test", true, "chat.fleunce.android.uitest").enabled)
        assertTrue(MinutePurchaseCapability.checked(true, "test", true, "chat.fleunce.android").enabled)
        assertTrue(MinutePurchaseCapability.checked(true, "live", true, "chat.fleunce.android", "stripe").enabled)
        assertFalse(MinutePurchaseCapability.checked(true, "live", true, "chat.fleunce.android", "unknown").enabled)
        assertEquals("live", MinutePurchaseCapability.checked(true, "live", true, "chat.fleunce.android").environment)
    }
