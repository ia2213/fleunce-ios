...
class LanguageDetectorTest {
    ...
    @Test fun onlyLongPassagesNotYetRedirectedAreChecked() {
        fun passage(id: String, text: String) = chat.fleunce.core.Passage(id, chat.fleunce.core.Speaker.assistant,
            listOf(chat.fleunce.core.Fragment(id = id, speaker = chat.fleunce.core.Speaker.assistant, text = text, startMS = 0, endMS = 1)))
